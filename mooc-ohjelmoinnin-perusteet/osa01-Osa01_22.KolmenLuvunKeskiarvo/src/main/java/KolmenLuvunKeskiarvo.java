 ...
 * 
 * Osa 1 - Tehtävä 22 - Kolmen luvun keskiarvo
 * 
...
public class KolmenLuvunKeskiarvo {
    ...
    public static void main(String[] args) {
        ...
        double syotettyjenLukujenKeskiarvo = 
            (double) (syotettyEnsimmainenLuku + syotettyToinenLuku 
            + syotettyKolmasLuku) / 3;
        
        System.out.println("Syötettyjen lukujen keskiarvo on " + 
            syotettyjenLukujenKeskiarvo
        );
    }
}
